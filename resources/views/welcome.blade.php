...
@section('nav')
  @include('templates.navbar.navbar_welcome')
@endsection
...
<header class="hero parallax-container" id="inicio">
    <div class="inner-hero section no-pad-bot">
      <div class="container inner-hero">
        <h1 class="title-hero anime-scroll-left">      <img src="{{asset('imgs/img_website_style/white-logo.png')}}" alt="">LIBRAS Academy</h1>
        <h2 class="title-hero anime-scroll-right">Abra sua mente para uma nova forma de comunicação</h2>
      </div>
    </div>
    <div class="parallax">
      <img src="imgs/img_website_style/hero_image.jpg">
    </div>
  </header>
  ...
  <div class="parallax-container section-parallax" id="como_funciona">
    ...
    <div class="parallax">
      <img src="imgs/img_website_style/section1_welcomepage.jpg">
    </div>
  </div>
 ...
 <div class="parallax-container section-parallax" id="cadastro">
  <div class="section">
    <div class="container">
      ...
      <h3 class="text-center anime-scroll-right"><a class="waves-effect waves-light btn pulse green darken-1" href="./register">Cadastrar</a></h3>
      <h3 class="text-center anime-scroll-right"><a class="waves-effect waves-light btn pulse green darken-1" href="./login">Login</a></h3>
    </div>
  </div>
  <div class="parallax">
    <img src="imgs/img_website_style/section2_welcomepage.jpg">
  </div>
</div>
@endsection
